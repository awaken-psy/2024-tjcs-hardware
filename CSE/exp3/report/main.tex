...
\lstdefinestyle{c}{
    ...
    frame=single,
    rulecolor=\color{codegray},
    morekeywords={int, void, char, unsigned, long, static, extern, volatile,
                  return, if, else, for, while, do, switch, case, break,
                  struct, typedef, enum, define, include, sizeof},
}
...
\newcommand{\imgph}[3]{%
  \begin{figure}[H]
    \centering
    \fbox{\parbox[c][5cm][c]{0.75\textwidth}{\centering\textit{【截图占位】}\\[6pt]\small #3}}
    \caption{#2}\label{#1}
  \end{figure}}
...
\input{sections/2_environment.tex}
\input{sections/3_architecture.tex}
\input{sections/4_hardware.tex}
\input{sections/5_software.tex}
\input{sections/6_pc_client.tex}
\input{sections/7_verification.tex}
\input{sections/8_summary.tex}
